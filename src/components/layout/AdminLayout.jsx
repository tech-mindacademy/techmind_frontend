    ...
    <div className="flex flex-col h-full w-64 bg-slate-950 border-r border-slate-800">
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        {navItems.map((item) => (
          <NavLink
            ...
            onClick={onClose}
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${isActive ? "bg-orange-900/50 text-orange-300" : "text-slate-400 hover:bg-slate-800 hover:text-white"}`
            }
          >
            <svg
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-orange-900/60 flex items-center justify-center text-sm font-bold text-orange-300">
        ...
        <button
          onClick={logout}
          className="w-full flex items-center gap-2 px-3 py-2 text-sm text-slate-500 hover:text-red-400 hover:bg-red-950/40 rounded-xl transition"
        >
          <svg
            className="w-4 h-4"
            fill="none"
