  ...
  <Suspense fallback={<PageLoader />}>
    <Routes>
      ...
      <Route element={<CreatorRoutes />}>
        ...
        <Route path="/creator/courses/:courseId/lessons/:lessonId/quiz" element={<QuizBuilder />} />
        <Route path="/creator/courses/:courseId/lessons/:lessonId/assignment" element={<AssignmentBuilder />} />
