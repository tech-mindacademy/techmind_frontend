...
function FilterPanel({ category, setCategory, price, setPrice, rating, setRating, setSearch, setPage, onClose }) {
  ...
  return (
    <div className="p-5">
      ...
      {/* PRICE */}
      <h3 className="font-semibold mb-3 text-gray-900 dark:text-white">Price</h3>
      {["All", "Free", "Paid"].map((p) => (
        <p
          key={p}
...
export default function CoursesLandingPage() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen">
        ...
        <div className="flex items-center justify-between gap-3 mt-5 flex-wrap">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <select
              ...
              className="flex-1 md:w-[220px] px-4 py-2 rounded-xl bg-white dark:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
            ...
            <button
              ...
              className="lg:hidden flex items-center gap-2 px-4 py-2 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 transition relative"
            >
              ...
              Filters
              {activeFilterCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-indigo-600 text-white text-xs flex items-center justify-center font-bold">
                  {activeFilterCount}
                </span>
              )}
            </button>
      ...
      {/* BODY */}
      <div className="max-w-7xl mx-auto px-4 mt-6 grid grid-cols-1 lg:grid-cols-4 gap-6 pb-20">

        {/* DESKTOP SIDEBAR */}
        <aside className="hidden lg:block bg-white dark:bg-gray-900 rounded-2xl h-fit sticky top-24">
          <FilterPanel
            category={category} setCategory={setCategory}
            price={price} setPrice={setPrice}
            rating={rating} setRating={setRating}
